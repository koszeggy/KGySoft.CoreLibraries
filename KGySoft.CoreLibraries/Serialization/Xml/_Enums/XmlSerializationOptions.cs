...
namespace KGySoft.Serialization.Xml
{
    ...
    public enum XmlSerializationOptions
    {
        ...
        /// <para>With every option disabled only those types are serialized, which are guaranteed to be able to deserialized perfectly. Such types are:
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>Ignores the originally defined <see cref="DefaultValueAttribute"/> definitions for all the properties. This causes that all members will be serialized regardless of their values.</para>
        /// <para>Default state at serialization methods: <strong>Disabled</strong></para>
        /// </summary>
        IgnoreDefaultValueAttribute = 1 << 5,

        /// <summary>
        /// <para>Ignores the presence of <c>ShouldSerialize&lt;PropertyName&gt;</c> methods for all the members.</para>
        /// <para>Default state at serialization methods: <strong>Disabled</strong></para>
        /// </summary>
        ...
        /// <note type="caution">Enabling this option can make it possible that properties without setter accessor will not be able to be deserialized.
