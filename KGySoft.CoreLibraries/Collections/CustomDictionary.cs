...
{
    /// <summary>
    /// Just like a normal <see cref="Dictionary{TKey,TValue}"/> but with additional features like custom hashing strategy or externally precalculated hash.
    /// Expected to be used as the complementary part of other hashing collections. When instantiated, always has a preallocated storage.
    /// Not thread-safe so the consumer must do the locking for the Try... members.
    /// </summary>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    internal sealed class CustomDictionary<TKey, TValue> //: IDictionary<TKey, TValue>
        where TKey : notnull
    {
