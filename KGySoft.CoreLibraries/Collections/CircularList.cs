...
namespace KGySoft.Collections
{
    ...
    public class CircularList<T> : ISupportsRangeList<T>, IList
    {
        ...
        private static BinarySearchHelper<T> BinarySearchHelperInstance
        {
            ...
            [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(ComparableBinarySearchHelper<string>))] // it provides a shareable implementation for reference types
            get
            {
...
#error Check if the generic bridge feature is already available. It would help AOT mode - https://github.com/dotnet/csharplang/discussions/6308
                        ...
                        {
                            // could not dynamically create ComparableBinarySearchHelper<T> - maybe T is a value type
