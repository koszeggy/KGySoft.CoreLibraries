...
#pragma warning disable CS1574 // the documentation contains types that are not available in every target
    ...
    public interface IStringKeyedDictionary<TValue> : IDictionary<string, TValue>
    {
        ...
        [return:MaybeNull]TValue GetValueOrDefault(string key);
        ...
        /// <param name="key">The key whose value to get.</param>
        /// <returns>The found value or the default value of <typeparamref name="TValue"/> if <paramref name="key"/> was not found in the dictionary.</returns>
        [return:MaybeNull]TValue GetValueOrDefault(StringSegment key);
        ...
        /// <returns>The found value or the default value of <typeparamref name="TValue"/> if <paramref name="key"/> was not found in the dictionary.</returns>
        /// <remarks><note>This member is available only in .NET Core 3.0/.NET Standard 2.1 and above.</note></remarks>
        [return:MaybeNull]TValue GetValueOrDefault(ReadOnlySpan<char> key);
