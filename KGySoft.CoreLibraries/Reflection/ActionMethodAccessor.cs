    ...
    internal sealed class ActionMethodAccessor : MethodAccessor
    {
        ...
        private protected override Delegate CreateGenericInvoker()
        {
            ...
            else
            {
                ...
                var dm = new DynamicMethod("<InvokeMethod>__" + method.Name, Reflector.VoidType,
                ...
                return dm.CreateDelegate(delegateType.GetGenericType(new[] { declaringType }.Concat(ParameterTypes).ToArray()));
#else
