...
namespace KGySoft
{
    ...
    internal static class Throw
    {
        ...
        [ContractAnnotation("=> halt")]internal static void KeyNotFoundException() => throw CreateKeyNotFoundException(Res.IDictionaryKeyNotFound);
        [ContractAnnotation("=> halt")]internal static void KeyNotFoundException(string message) => throw CreateKeyNotFoundException(message);
        [ContractAnnotation("=> halt")]internal static T KeyNotFoundException<T>(string message) => throw CreateKeyNotFoundException(message);

        [ContractAnnotation("=> halt")]internal static void InvalidOperationException(string message) => throw CreateInvalidOperationException(message);
        [ContractAnnotation("=> halt")]internal static T InvalidOperationException<T>(string message) => throw CreateInvalidOperationException(message);
        [ContractAnnotation("=> halt")]internal static T InvalidOperationException<T>(string message, Exception inner) => throw CreateInvalidOperationException(message, inner);

        [ContractAnnotation("=> halt")]internal static void InternalError(string internalError) => throw CreateInvalidOperationException(Res.InternalError(internalError));
        [ContractAnnotation("=> halt")]internal static T InternalError<T>(string internalError) => throw CreateInvalidOperationException(Res.InternalError(internalError));

        internal static void MissingManifestResourceException(string message) => throw new MissingManifestResourceException(message);

        [ContractAnnotation("=> halt")]internal static void NotSupportedException() => throw CreateNotSupportedException(Res.NotSupported);
        [ContractAnnotation("=> halt")]internal static T NotSupportedException<T>() => throw CreateNotSupportedException(Res.NotSupported);
        [ContractAnnotation("=> halt")]internal static void NotSupportedException(string message) => throw CreateNotSupportedException(message);
        [ContractAnnotation("=> halt")]internal static T NotSupportedException<T>(string message) => throw CreateNotSupportedException(message);
        [ContractAnnotation("=> halt")]internal static void NotSupportedException(string message, Exception inner) => throw CreateNotSupportedException(message, inner);

        [ContractAnnotation("=> halt")]internal static void ObjectDisposedException() => throw CreateObjectDisposedException(Res.ObjectDisposed);
        [ContractAnnotation("=> halt")]internal static void ObjectDisposedException(string name) => throw CreateObjectDisposedException(Res.ObjectDisposed, name);

        [ContractAnnotation("=> halt")]internal static void ReflectionException(string message) => throw CreateReflectionException(message);
        [ContractAnnotation("=> halt")]internal static T ReflectionException<T>(string message) => throw CreateReflectionException(message);
        [ContractAnnotation("=> halt")]internal static void ReflectionException(string message, Exception inner) => throw CreateReflectionException(message, inner);

        [ContractAnnotation("=> halt")]internal static void TypeLoadException(string message) => throw CreateTypeLoadException(message);
        [ContractAnnotation("=> halt")]internal static void TypeLoadException(string message, Exception inner) => throw CreateTypeLoadException(message, inner);

        [ContractAnnotation("=> halt")]internal static void FileNotFoundException(string message, string fileName) => throw new FileNotFoundException(message, fileName);

        [ContractAnnotation("=> halt")]internal static void SerializationException(string message) => throw CreateSerializationException(message);
        [ContractAnnotation("=> halt")]internal static T SerializationException<T>(string message) => throw CreateSerializationException(message);
        [ContractAnnotation("=> halt")]internal static void SerializationException(string message, Exception inner) => throw CreateSerializationException(message, inner);

        internal static void PlatformNotSupportedException(string message) => throw CreatePlatformNotSupportedException(message);
        internal static T PlatformNotSupportedException<T>(string message) => throw CreatePlatformNotSupportedException(message);
