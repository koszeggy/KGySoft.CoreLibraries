...
namespace KGySoft.Resources
{
    ...
    /// <description>If <see cref="CompatibleFormat"/> is <see langword="true"/>, the resulting .resx file can be read by <a href="https://learn.microsoft.com/en-us/dotnet/api/system.resources.resxresourcereader" target="_blank">System.Resources.ResXResourceReader</a>.</description></item>
    ...
    /// <term>The <a href="https://learn.microsoft.com/en-us/dotnet/api/system.resources.resxresourcewriter" target="_blank">System.Resources.ResXResourceWriter</a> changes the <see cref="sbyte">sbyte[]</see> types to <see cref="byte">byte[]</see>.</term></item>
    ...
    /// <a href="https://learn.microsoft.com/en-us/dotnet/api/system.resources.resxresourcereader" target="_blank">System.Resources.ResXResourceReader</a> can read them successfully if they are serialized by <see cref="ResXResourceWriter"/> and <see cref="CompatibleFormat"/> is <see langword="true"/>.</term></item>
    ...
    /// <term><a href="https://learn.microsoft.com/en-us/dotnet/api/system.resources.resxresourcewriter" target="_blank">System.Resources.ResXResourceWriter</a> can serialize these type only by <see cref="BinaryFormatter"/>.
    ...
    /// <term>If <see cref="CompatibleFormat"/> is <see langword="true"/> during serialization, deserialization works even with <a href="https://learn.microsoft.com/en-us/dotnet/api/system.resources.resxresourcereader" target="_blank">System.Resources.ResXResourceReader</a>
    ...
    <xsd:schema id=""root"" xmlns="""" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns:msdata=""urn:schemas-microsoft-com:xml-msdata"">
        ...
        /// <see cref="IntPtr"/>, <see cref="UIntPtr"/>, <see cref="Type"/>, <see cref="BigInteger"/>, <see cref="Rune"/>, <see cref="Half"/>,
