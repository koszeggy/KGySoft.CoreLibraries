...
namespace KGySoft.CoreLibraries.UnitTests.Serialization.Binary
{
    ...
    public class ForwardedTypesSerializationBinderTest : TestBase
    {
        ...
        public void DeserializeTypeFromUnknownAssembly()
        {
            ...
            // without a binder
            AssertThrows<SerializationException>(() => new BinarySerializationFormatter(BinarySerializationOptions.None).Deserialize(oldAssemblyData), "Failed to load assembly by name: \"SomeUnknownAssembly, Version=1.2.3.4, Culture=neutral, PublicKeyToken=b45eba277439ddfe\"");
