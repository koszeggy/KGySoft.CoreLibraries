...
namespace KGySoft.Libraries.Resources
{
    ...
    /// </summary>
    /// <remarks>
    /// The <see cref="N:KGySoft.Libraries.Resources"/> namespace contains several classes, which can handle resources from XML resources (.resx files).
    ...
    /// (Though you can call the <see cref="ResXResourceManager.GetExpandoResourceSet">GetExpandoResourceSet</see> method to access the various <see cref="O:KGySoft.Libraries.Resources.IExpandoResourceSet.Save">Save</see> overloads)</item>
