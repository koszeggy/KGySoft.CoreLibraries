...
namespace KGySoft.Libraries.Serialization
{
    ...
    public interface IBinarySerializable
    {
        ...
        /// </summary>
        /// <param name="options">Options that were used when serialization of the object was invoked. Unless you use <see cref="BinarySerializer.Serialize(object,KGySoft.Libraries.Serialization.BinarySerializationOptions)"/>
